        ...
        <div class="mx-auto w-3/4 pt-10 lg:w-full lg:px-20">
            ...
            <div class="w-full border-2 border-gray-300 shadow flex flex-col mb-4 md:justify-between">
                ...
                <div class="grid grid-cols gap-8 w-full mb-16 sm:grid-cols-2 lg:grid-cols-5">
                        <div v-for="product in products" :key="product.id" class="h-32 flex flex-col items-center text-center">
                            <img v-if="product.images" class="h-24 w-24" :src="firstImage(product)">
...
export default {
    ...
    methods: {
        ...
        firstImage(product) {
            ...
            ? this.imgUrl + product.images[0].image
